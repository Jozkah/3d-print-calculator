    ...
    <div className="min-h-screen bg-white">
      <div className="border-b-2 border-blue-200 bg-white">
        <div className="max-w-[1600px] mx-auto p-6">
          ...
          <h1 className="text-3xl font-bold text-blue-600">Business Calculator</h1>
          <p className="text-gray-600 mt-2">Calculate costs with profit split for business projects</p>
        </div>
      </div>
      <ExcelCalculator
        mode="business"
