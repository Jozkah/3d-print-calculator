...
// Logos are stored inline as data URIs on the settings row, so keep them small.
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1.5">PNG/JPG/SVG up to 200KB, stored with your settings</p>
          </div>
        </CardContent>
      </Card>
